...
public class ElectrickBikeCategories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrick_bike_categories);
    ...
    public void back(View view) {
        ElectrickBikeCategories.super.onBackPressed();
    }
}