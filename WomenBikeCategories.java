...
public class WomenBikeCategories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_bike_categories);
        //Hooks
    ...
    public void back(View view) {
        WomenBikeCategories.super.onBackPressed();
    }
}